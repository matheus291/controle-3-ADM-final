...
if st.button('Iniciar'):
    enviar = f"INSERT INTO controle (dia_vendido, período, Tradicional, Adicional_ambos, adicional_creme_de_avelã, adicional_paçoca) VALUES ({dia}, '{periodo}', {t}, {ada}, {adc}, {adp})"
